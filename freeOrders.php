...
<html>
    ...
    <body onload="onLoad()">
            ...
            <div class="content">
                ...
                <div class="nav_type_orders">
                    <div class="left_arrow">
                        <img src="../img/arrowL_unvis.png" class="s_img_class">
                    </div>
                    <div class="nav_type_text">
        ...
        <script type="text/javascript" src="../moduls/freeOrdersScripts.js" defer></script>
