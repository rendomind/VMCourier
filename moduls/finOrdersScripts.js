...
function GetMakeOrd() {
    ...
    if (res[0].number_fields > 0) {
        ...
        $('#id_final_earnings').text('Заработок: ' + Math.round(0.7 * (res[0].final_summ_nal + res[0].final_summ_no_nal)) + ' руб.');
        $('#id_final_earnings_nal').text('Получено на руки: ' + res[0].final_summ_nal + ' руб.');
        $('#id_final_earnings_no_nal').text('Остаток на карту: ' + (Math.round(0.7 * (res[0].final_summ_nal + res[0].final_summ_no_nal)) - res[0].final_summ_nal) + ' руб.');
    }
}
